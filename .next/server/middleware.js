...
Object(function webpackMissingModule() { var e = new Error("Cannot find module '@supabase/auth-helpers-nextjs'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());


async function middleware(req) {
    const res = NextResponse.next();
    const supabase = Object(function webpackMissingModule() { var e = new Error("Cannot find module '@supabase/auth-helpers-nextjs'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())({
        req,
        res
    });
